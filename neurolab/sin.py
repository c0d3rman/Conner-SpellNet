...
inputLayerSize = 1
inputLayerBounds = [-7, 7]
outputLayerSize = 1
hiddenLayerSize = 5
net = nl.net.newff([inputLayerBounds] * inputLayerSize, [hiddenLayerSize, outputLayerSize])
...
# Test
def test(num):
	print str(num) + " -> " + str(net.sim([[num]])[0][0]) + " (" + str(np.sin(num)) + ")"
