...
net = nl.net.newff(shape, [20, 20, 20])
#net.trainf = 
# Train process
error = net.train(input, target, show=1, epochs=100, goal=10)

timeit("Training")

# Test
print unconvert(net.sim([convert("basicly")])[0])
